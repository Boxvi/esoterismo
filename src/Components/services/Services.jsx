...
const Services = () => {
  return (
    <section id='services' className="services">
      ...
      <div className="services__item">
        <img className="services__item-img" src={tarot} alt="tarot" />
        <h3 className="services__item-heading">Tarot</h3>
        <p className="services__item-paragraph">
        El Tarot no es magia… es la llave que abre las puertas que ya llevas dentro. Solo necesitabas recordar dónde guardaste la clave.
        </p>
      </div>
